...
class HDP():
    ...
    def update_beliefs_context(self, tau, t, posterior_policies, likelihood_policies):
        ...
        if t>0:
            ...
            #     context_likelihood[:2] = [0.9999, 1-0.9999]
        ...
        if tau <40:
            ...
            a[a == -46.0517] = 0
            print("prior")
            print(self.ln(self.transition_matrix*prior_context[None,:]).round(5))
            print("obs_messages")
            print(obs_messages.round(5))
            print("q_z*obs_messages")
            print((q_z*obs_messages).round(5))
